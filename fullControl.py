...
def gui():
    ...
    breakPres1= tk.Label(main, text="break Pressure 1",fg="black", font=("Courier", 12), bg="#D6C2C2", relief=SUNKEN)
    breakPres1.grid(row = 10, column = 9, padx=4, pady=2, columnspan = 1, sticky=N+S+E+W)
    breakPres1Min= tk.Label(main, text=0.125,fg="black", font=("Courier", 12), bg="#D6C2C2", relief=SUNKEN)
    breakPres1Min.grid(row = 10, column = 10, padx=4, pady=2, columnspan = 1, sticky=N+S+E+W)   
    breakPres1Max= tk.Label(main, text=14.7,fg="black", font=("Courier", 12), bg="#D6C2C2", relief=SUNKEN)
    ...
    breakPres2= tk.Label(main, text="break Pressure 2",fg="black", font=("Courier", 12), bg="#D6C2C2", relief=SUNKEN)
    breakPres2.grid(row = 12, column = 9, padx=4, pady=2, columnspan = 1, sticky=N+S+E+W)
    breakPres2Min= tk.Label(main, text=0.125,fg="black", font=("Courier", 12), bg="#D6C2C2", relief=SUNKEN)
    breakPres2Min.grid(row = 12, column = 10, padx=4, pady=2, columnspan = 1, sticky=N+S+E+W)   
    breakPres2Max= tk.Label(main, text=14.7,fg="black", font=("Courier", 12), bg="#D6C2C2", relief=SUNKEN)
